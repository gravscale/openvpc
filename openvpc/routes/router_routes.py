...
@router.post("/router", response_model=RouterRead)
...
@router.get("/router/{router_id}", response_model=RouterRead)
...
@router.put("/router/{router_id}", response_model=RouterRead)
...
@router.delete("/router/{router_id}", response_model=RouterRead)
...
@router.get("/router", response_model=List[RouterRead])
