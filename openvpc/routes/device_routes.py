...
@router.post("/admin/credential", response_model=CredentialRead, operation_id="admin-credential-add")
...
@router.get("/admin/credential/{credential_id}", response_model=CredentialRead, operation_id="admin-credential-get")
...
@router.put("/admin/credential/{credential_id}", response_model=CredentialRead, operation_id="admin-credential-update")
...
@router.delete("/admin/credential/{credential_id}", response_model=CredentialRead, operation_id="admin-credential-del")
...
@router.get("/admin/credential", response_model=List[CredentialRead], operation_id="admin-credential-list")
...
@router.put("/admin/device/{device_id}", response_model=DeviceRead, operation_id="admin-device-update")
...
@router.delete("/admin/device/{device_id}", response_model=DeviceRead, operation_id="admin-device-del")
