...
class RouterBase(BaseModel):
    ...
    def check_vpc_uuid_or_name(cls, v, info: FieldValidationInfo):
        if ('vpc_uuid' in info.data and 'vpc_name' in info.data) or ('vpc_name' in info.data and 'vpc_uuid' in info.data):
...
class RouterRead(RouterBase):
    id: UUID = Field(..., description="Unique identifier for the router")
